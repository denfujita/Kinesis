...
\begin{table}[h]
\centering
\caption{Projected motion imitation results: PPO baseline vs.\ PPO+DEP across morphologies. Projections are based on DEP-RL sample efficiency ratios and Kinesis baseline MPJPE. $\downarrow$ = lower is better, $\uparrow$ = higher is better.}
\label{tab:main}
\small
\begin{tabular}{llcccc}
\toprule
\textbf{Model} & \textbf{Method} & \textbf{MPJPE$\downarrow$} & \textbf{RMSE$\downarrow$} & \textbf{Act.Vol.$\downarrow$} & \textbf{Cov.$\uparrow$} \\
& & (mm) & (rad) & & \\
\midrule
\multirow{2}{*}{80}
& PPO & 106.4 & 0.142 & 22.6 & 0.82 \\
& PPO+DEP & \textbf{62.6} & \textbf{0.098} & \textbf{9.1} & \textbf{0.89} \\
\midrule
\multirow{2}{*}{86}
& PPO & 118.5 & 0.156 & 23.0 & 0.74 \\
& PPO+DEP & \textbf{71.3} & \textbf{0.112} & \textbf{10.4} & \textbf{0.83} \\
\midrule
\multirow{2}{*}{290}
& PPO & 142.2 & 0.193 & 68.7 & 0.63 \\
& PPO+DEP & \textbf{95.8} & \textbf{0.141} & \textbf{38.2} & \textbf{0.76} \\
\bottomrule
\end{tabular}
\end{table}
