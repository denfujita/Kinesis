...
\midrule
PPO baseline & 94.6 $\pm$ 1.9 & 0.113 $\pm$ 0.004 & 28.0 & 0.82 & 245 \\
PPO + DEP     & 59.4 $\pm$ 1.9 & 0.071 $\pm$ 0.003 & 44.2 & 0.89 & 97 \\
\bottomrule
\end{tabular}
\end{table}

Figure~\ref{fig:learning} illustrates the learning curves. DEP-augmented training converges faster and reaches lower final MPJPE. The higher activation volume for DEP reflects coordinated muscle recruitment during the structured exploration phases, consistent with the muscle synergy patterns observed in the MuJoCo experiments.
